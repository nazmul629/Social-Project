...
def about(request):
    ...
    return render(request, 'blooddonor/about.html', context)
...
def blood_request(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, f'Your Message has been published! Hopefully You Will Get The Expected Blood Donor')
            return redirect('home')
    else:
